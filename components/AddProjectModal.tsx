...
export const AddProjectModal: React.FC<AddProjectModalProps> = ({ onClose, onSave, users }) => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-70 flex justify-center items-center z-20 animate-fadeIn" onClick={onClose}>
      ...
      >
        <div className="flex justify-between items-center mb-6">
          <h2 id="addProjectModalTitle" className="text-2xl font-bold text-gray-900 dark:text-gray-100">Créer un Nouveau Projet</h2>
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label htmlFor="name" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Nom du Projet</label>
          ...
          <div className="mb-6">
             <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Membres de l'Équipe</label>
          ...
          <div className="flex justify-end space-x-4">
            ...
            <button type="submit" className="px-6 py-2 bg-mauve-600 text-white rounded-lg hover:bg-mauve-700">Créer le Projet</button>
          </div>
        </form>
      </div>
    </div>
